...
export default function AddPage() {
    ...
    const getKelas = () => {
        axios.get(process.env.REACT_APP_API_LINK + `api/kelas/kelasData`, {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        axios.post(process.env.REACT_APP_API_LINK + 'api/alumni/addAlumni', {
            nisn,
            nama,
            kelas,
            alamat,
        ...
        <div className="d-flex justify-content-center align-items-center">
                ...
                <Form onSubmit={handleSubmit}>
                    ...
                    <Form.Group className="mb-3" controlId="formBasicNISN">
                        ...
                        <div className="inputWithIcon">
                            <Form.Control type="text" placeholder="Masukkan NISN"  value={nisn} onChange={(e)=> setNISN(e.target.value)} />
                    ...
                    <Form.Group className="mb-3" controlId="formBasicNama">
                        ...
                        <div className="inputWithIcon">
                            <Form.Control type="text" placeholder="Masukkan Nama" value={nama} onChange={(e)=> setNama(e.target.value)} />
                            <i className="fa fa-user fa-lg fa-fw" aria-hidden="true"></i>
                        </div>
                    </Form.Group>
                    <Form.Group className="mb-3">
                        <Form.Label>Kelas</Form.Label>
                        <Form.Select value={kelas} onChange={(e)=> setJurusan(e.target.value)}>
                    ...
                    <Form.Group className="mb-3">
                        <Form.Label>Angkatan</Form.Label>
                            <Form.Select value={angkatan} onChange={(e)=> setAngkatan(e.target.value)}>
                        ...
                        <Form.Group className="mb-3">
                            ...
                            <Form.Select value={jenis_kelamin} onChange={(e)=> setJenis_kelamin(e.target.value)}>
                        ...
                        <Form.Group className="mb-3" controlId="formBasicHP">
                            ...
                            <div className="inputWithIcon">
                                <Form.Control type="text" value={no_hp} onChange={(e)=> setNo_telp(e.target.value)} placeholder="Masukkan No HP" />
            ...
            {kuliahStatus ? (
              <Form.Group className="mb-3">
                ...
                <Link to={'/universitas/add'}>tidak menemukan universitas yang sesuai?</Link>
              </Form.Group>
            ) : null}
            {kerjaStatus ? (
              <Form.Group className="mb-3">
