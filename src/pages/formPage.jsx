...
export default function Formalumni() {
  ...
  const handleSubmit = (e) => {
    ...
    axios
      .post(
        process.env.REACT_APP_API_LINK + "api/alumni/addAlumni",formData,
        {
          headers: {
      ...
      .then((res) => {
        ...
        if(Array.from(status)[0] == "u"){
          ...
          .put(process.env.REACT_APP_API_LINK + "api/kuliah/updateKuliahbyname/"+status,{
            ...
            if(res.data.status == true){setPostStatus(true);}
          })
        }
  ...
  return (
    <>
      ...
      {postStatus ? (
        <Alert severity="success">Data Berhasil disimpan</Alert>
      ) : null}
      {error ? (
          ...
          <Form onSubmit={handleSubmit}>
            ...
            {kuliahStatus ? (
              <Form.Group className="mb-3">
                ...
                <Link to={"/form/universitas/" + token}>
            ...
            {wirausahaStatus ? (
              <Form.Group className="mb-3">
                ...
                <Link to={"/form/wirausaha/"+token}>
                  tidak menemukan wirausaha yang sesuai?
                </Link><br />
                <Form.Label>posisi</Form.Label>
              <div >
                <Form.Control
